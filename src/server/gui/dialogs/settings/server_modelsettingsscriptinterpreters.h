#ifndef SERVER_MODELSETTINGSSCRIPTINTERPRETERS_H
#define SERVER_MODELSETTINGSSCRIPTINTERPRETERS_H

#include <QAbstractItemModel>

class mbServerModelSettingsScriptInterpreters : public QAbstractItemModel
{
public:
    explicit mbServerModelSettingsScriptInterpreters(QObject *parent = nullptr);
...
#endif // SERVER_MODELSETTINGSSCRIPTINTERPRETERS_H
